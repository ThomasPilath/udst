  ...
  return (
    <div className='flex flex-col border-2 rounded-lg p-4'>
      ...
      {societies.map((society) => {
        return (
          <Button id={String(society.id)} onClick={e => handleSelect(e, society.id)} className='flex flex-col gap-4 justify-center items-center h-36 w-36 bg-stone-400/25 hover:bg-stone-100/25 p-2'>
